...
import { useBookInCartStore } from '@/stores/cartStore' // ← Agregar esto
...
<template>
    ...
    <aside
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-4">
            <div v-for="book in booksInCart" :key="book.id"
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">{{ book.qty }} x ${{ book.price }} = ${{ book.qty * book.price }}</p>
                </div>
                <button @click="store.removeBookInCart(book)" class="text-red-500 hover:text-red-700">
